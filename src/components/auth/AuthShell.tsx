...
export function AuthShell({
  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)]">
      {/* Brand panel */}
      <div
        className="relative hidden w-[560px] shrink-0 flex-col justify-between overflow-hidden p-10 lg:flex"
        style={{ background: "linear-gradient(160deg,#051e29 0%,#0E4D5C 58%,#0c4454 100%)" }}
      >
        <span className="pointer-events-none absolute -right-20 -top-24 size-[340px] rounded-full bg-white/[0.03]" />
        <span className="pointer-events-none absolute -bottom-20 -left-14 size-[280px] rounded-full bg-gold-400/[0.05]" />
